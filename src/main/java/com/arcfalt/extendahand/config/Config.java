...
public class Config
{
	...
	private static void read()
	{
		...
		baseCooldown = config.getInt("baseCooldown", baseCategory, baseCooldown, cooldownMin, cooldownMax, "The amount of ticks until the basic tool can be used again. One second is approximately 20 ticks without server lag. Set to 0 to disable the cooldown and allow for instant usage.");
		...
		lineCooldown = config.getInt("lineCooldown", lineCategory, lineCooldown, cooldownMin, cooldownMax, "The amount of ticks until the line tool can be used again. One second is approximately 20 ticks without server lag. Set to 0 to disable the cooldown and allow for instant usage.");
		...
		boxCooldown = config.getInt("boxCooldown", boxCategory, boxCooldown, cooldownMin, cooldownMax, "The amount of ticks until the box tool can be used again. One second is approximately 20 ticks without server lag. Set to 0 to disable the cooldown and allow for instant usage.");
		...
		//boxUndoLevels = config.getInt("boxUndoLevels", boxCategory, boxUndoLevels, undoMin, undoMaxBox, "The amount of actions the box tool will remember so that they can be undone. Recommended lower or off for box select due to high amount of blocks.");
